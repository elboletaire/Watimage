...
$image->resize('resizecrop', 400, 200)
    ->generate($output_path . 'image1-resizecrop.png');
...
$image->rotate(90, '#fff')
    ->generate($output_path . 'image2-rotate.png');

/**********************************
 *** EXPORTING TO OTHER FORMATS ***
 **********************************/
$image = new Image($image_file);
$image->generate($output_path . 'image3-formats.jpg', 'image/jpeg');
...
$image->flip('vertical')
    ->generate($output_path . 'image4-flip.png');
...
$image->crop([
    ...
    ->generate($output_path . 'image5-crop.png');
